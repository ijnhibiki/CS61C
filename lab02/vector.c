...
vector_t *bad_vector_new() {
    ...
    //the struct is created on the stack, instead of the heap. 
    //All memory stored on the stack gets freed as soon as that 
    //function finishes running, so when the function returns, we lose the vector we constructed.
